...
parser = argparse.ArgumentParser(description='neural network-based cell of origin classifier')
...
parser.add_argument('test_name', help='Input the test dataset name for cell of origin classification. e.g., medulloblastoma')
...
adata_train = adata_ref[cells_train, :].copy()
adata_valid = adata_ref[cells_valid, :].copy()
del adata_ref
